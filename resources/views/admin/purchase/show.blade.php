							...
							<table id="detalles" class="table">
								...
								<tbody>
									@foreach($purchaseDetails as $purchaseDetail)
										<tr>
											<td>
												{{ $purchaseDetail->product->codigo }}<br>
												{{ $purchaseDetail->product->name }}
											</td>
											<td align="right">Bs. {{ $purchaseDetail->price }}</td>
											<td align="right">{{ $purchaseDetail->quantity }}</td>
											<td align="right">Bs. {{ number_format($purchaseDetail->quantity * $purchaseDetail->price,2) }}</td>
										</tr>
									@endforeach
								</tbody>
							</table>
