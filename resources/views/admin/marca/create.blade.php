        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Registrar Marca</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="abs-center">
                <div class="card">
                    <div class="card-header bg-dark text-white">
                        <h1 class="text-center">REGISTRAR NUEVA MARCA</h1>
                    </div>
                    <div class="card-body">

                        {!! Form::open(['route' => 'marcas.store', 'method' => 'POST', 'class' => 'registro']) !!}
                            @include('admin.marca._form')
