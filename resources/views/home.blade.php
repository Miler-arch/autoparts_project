                    ...
                    <div class="card-body">
                                ...
                                <div class="card text-white bg-success">
                                  <div class="card-body pb-0">
                                    ...
                                    <div class="text-value h3">
                                      <strong>Bs. {{ $total->totalcompra }} (Mes Actual)</strong>
                                    </div>
                            ...
                            <div class="col-md-6">
                              <div class="card text-white bg-info">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-value h3">
                                      <strong>Bs. {{ $total->totalventa }} (Mes Actual)</strong>
                                    </div>
                      ...
                      <div class="row mt-5">
                        <div class="col-md-6">
                          <div class="card card-chart">
                            <div class="card-header bg-dark">
                              <h4 class="text-center page-title text-white">Compras Mes</h4>
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="card card-chart">
                            <div class="card-header bg-dark">
                              <h4 class="text-center page-title text-white">Ventas Mes</h4>
                            </div>
                            <div class="card-content">
                              <div class="ct chart">
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="card card-chart">
                            <div class="card-header bg-dark">
                              <h4 class="text-center page-title text-white">Ventas diarias</h4>
                            </div>
                            <div class="card-content">
                              <div class="ct chart">
                 ...
                 <div class="card">
                    <div class="card-body">
                      ...
                      <div class="card-header d-flex align-items-center justify-content-between bg-dark">
                          <h4 class="text-center page-title text-white">Productos mas vendidos</h4>
                      </div>
